...
class CarState(CarStateBase):
  ...
  def update_tss3(self, can_parsers, starpilot_toggles):
    ...
    # Steering rides in the SAME 0x160 frame (tss3_accel_template, bytes 22-23) per Kev-ORG PR #3791,
    # so no separate 0x1A0 capture is needed. 0x1A0 is gateway-native and trips relayMalfunction; it is
    # not used. Leave the steer template unset (deprecated field kept for compatibility).
