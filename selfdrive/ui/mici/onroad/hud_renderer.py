...
class HudRenderer(Widget):
  ...
  def _draw_steering_wheel(self, rect: rl.Rectangle) -> None:
    ...
    # color and draw
    if self._wheel_tint is not None and not self._show_wheel_critical:
      base_color = self._wheel_tint
    elif lateral_ui_active and not self._show_wheel_critical:
      base_color = rl.Color(22, 127, 64, 255)   # green while openpilot has lateral control (engaged or AOL)
    else:
