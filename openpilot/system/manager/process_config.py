...
def eps_telescope(started: bool, params: Params, CP: car.CarParams) -> bool:
  return params.get_bool("EpsTelescopeRequested")
...
procs = [
  ...
  PythonProcess("eps_telescope", "openpilot.tools.eps_telescope.service", eps_telescope),
