...
from openpilot.selfdrive.ui.layouts.settings.eps_telescope import EpsTelescopeLayout
...
class SettingsLayout(Widget):
  def __init__(self):
    ...
    self._panels = {
      ...
      PanelType.EPS_TELESCOPE: PanelInfo(tr_noop("EPS Scope"), EpsTelescopeLayout()),
    }
