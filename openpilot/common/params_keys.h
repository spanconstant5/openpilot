...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"EpsTelescopeArtifactsDir", {PERSISTENT, STRING, "/data/eps_telescope"}},
    {"EpsTelescopeExportEnabled", {PERSISTENT, BOOL, "1"}},
    {"EpsTelescopeFingerprintVehicle", {PERSISTENT, BOOL, "1"}},
    {"EpsTelescopeLastReport", {PERSISTENT, STRING}},
    {"EpsTelescopeLastSummary", {PERSISTENT, JSON}},
    {"EpsTelescopeMode", {PERSISTENT, STRING, "uds"}},
    {"EpsTelescopeRequested", {CLEAR_ON_MANAGER_START, BOOL}},
    {"EpsTelescopeScanEgg", {PERSISTENT, BOOL, "1"}},
    {"EpsTelescopeStatus", {CLEAR_ON_MANAGER_START, JSON}},
